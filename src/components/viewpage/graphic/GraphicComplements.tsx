    ...
    public render() {
        ...
        return (
            <div className="row graphic-complements">
                ...
                <OptionsPicker onChangeOption={this.props.handleChangeAggregation} selected={this.selectedAggregation()} availableOptions={this.aggregationOptions()} label="Agregación" />
