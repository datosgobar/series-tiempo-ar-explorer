...
function webCodeUrl(url: string): string {
    return "<script type='text/javascript' src='https://cdn.jsdelivr.net/gh/datosgobar/series-tiempo-ar-explorer@ts_components_1.6.0/dist/js/components.js'></script>\n" +
        "<script type='text/css' src='https://cdn.jsdelivr.net/gh/datosgobar/series-tiempo-ar-explorer@ts_components_1.6.0/dist/css/components.css'></script>\n" +
        "<div id=\"root\"></div>\n" +
        "<script>\n" +
