...
function webCodeUrl(url: string): string {
    return "<script type='text/javascript' src='https://cdn.jsdelivr.net/gh/datosgobar/series-tiempo-ar-explorer@ts_components_1.4.5/dist/js/components.js'></script>\n" +
        "<div id=\"root\"></div>\n" +
        "<script>\n" +
