...
function webCodeUrl(url: string, chartTitle: string, chartSource: string): string {
    return "<script type='text/javascript' src='https://cdn.jsdelivr.net/gh/datosgobar/series-tiempo-ar-explorer@ts_components_1.12.1/dist/js/components.js'></script>\n" +
        "<link rel='stylesheet' type='text/css' href='https://cdn.jsdelivr.net/gh/datosgobar/series-tiempo-ar-explorer@ts_components_1.12.1/dist/css/components.css'/>\n" +
        "<div id=\"root\"></div>\n" +
        "<script>\n" +
