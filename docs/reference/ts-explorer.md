...
```html
<script type='text/javascript' src='https://cdn.jsdelivr.net/gh/datosgobar/series-tiempo-ar-explorer@2.5.1/dist/js/main.js'></script>
```
...
## Demo online
[https://jsfiddle.net/p4anhrgf/](https://jsfiddle.net/p4anhrgf/)
